...
public class SpecEntityTypeConfiguration : IEntityTypeConfiguration<Spec>
{
    ...
    new Spec { Id = Guid.Parse("{EC25EEAB-C424-477A-9B4A-A3B4F5C9E361}"), NameTr = "Yelkenin Sarılması", NameEn = "Winding Genoa" },
    ...
    new Spec { Id = Guid.Parse("{2A48445D-384E-4FD9-9100-60DF49125E1A}"), NameTr = "Temiz Su Tankı", NameEn = "Clean Water Tank" },
    ...
    new Spec { Id = Guid.Parse("{A0710B91-2461-41B6-A36D-827E7E68C21A}"), NameTr = "Yapıldığı Yıl", NameEn = "Built in" },
    new Spec { Id = Guid.Parse("{E7A5E5F6-C5D5-43BE-A7BC-68897D7977C1}"), NameTr = "Su Çekilmesi", NameEn = "Water Withdrawal" },
